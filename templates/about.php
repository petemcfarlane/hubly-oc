...
<div class="row">
	<div class="large-12 columns">
		<h1 class="align-center">About Hubly</h1>
		...
		<p>That's the idea behind Hubly - it's a <strong>personal hub designed to keep your settings safe, seucre and synchronized across all your devices and platforms.</strong></p>
	</div>
</div>
{% include '_footer.php' %}