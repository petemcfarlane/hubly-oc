...
<div class="row">
	<div class="large-6 columns large-offset-3">
		<h1>Sign up</h1>
		<form method="post" action="{{ url('hubly.page.signup') }}" class="block">
			<label for="sign_up_display_name">Display name</label>
			...
			<label for="sign_up_email_confirmation">Email address confirmation</label>
		...
		<p><a href="{{ url('hubly.page.login') }}">Click here to login if you are already registred</a></p>
	</div>
</div>
{% include '_footer.php' %}